          ...
          <div className="footer-logos-right">
            <div className="footer-logos-partners">
              ...
              <div className="footer-logos-partners-box">
                <div className="footer-logos-partners-box-top">
                ...
                <div className="footer-logos-partners-box-bottom">
                  ...
                  <a href="https://www.sunat.gob.pe/" target="_blank">
                    <img className="footer-logo-sunat" src="/icons/footer/logo-blanco-sunat.png" alt="SUNAT" />
                  </a>
            ...
            <div className="footer-logos-support">
              <div className="footer-logos-support-box">
                ...
                <div className="footer-logos-support-items">
